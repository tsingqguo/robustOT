...
__C.TRAIN.PARTIAL = CN()

__C.TRAIN.PARTIAL.BACKBONE = True

__C.TRAIN.PARTIAL.NECK = True

__C.TRAIN.PARTIAL.RPN_HEAD = True

__C.TRAIN.PARTIAL.MASK_HEAD = True

__C.TRAIN.PARTIAL.REFINE_HEAD = True
...
__C.DATASET.TEMPLATE.GN_MEAN = 0.0

__C.DATASET.TEMPLATE.GN_VAR = 0.0
...
__C.DATASET.SEARCH.GN_MEAN = 0.0

__C.DATASET.SEARCH.GN_VAR = 0.0
...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = "$TRAIN_DSET_PATH/vid/crop511"
__C.DATASET.VID.ANNO = "$TRAIN_DSET_PATH/vid/train.json"
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = "$TRAIN_DSET_PATH/yt_bb/crop511"
__C.DATASET.YOUTUBEBB.ANNO = "$TRAIN_DSET_PATH/yt_bb/train.json"
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = "$TRAIN_DSET_PATH/coco/crop511"
__C.DATASET.COCO.ANNO = "$TRAIN_DSET_PATH/coco/train2017.json"
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = "$TRAIN_DSET_PATH/det/crop511"
__C.DATASET.DET.ANNO = "$TRAIN_DSET_PATH/det/train.json"
...
print("[ERR] THIS FILE SHOULD NOT BE LOADED")
raise ImportError(
